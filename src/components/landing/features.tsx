import { ShieldCheck, Zap, Command, Sparkles, Star, Keyboard } from "lucide-react-motion";
        ...
        <Stagger className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-3">
          ...
          <StaggerItem className="lg:col-span-3">
            <WobbleCard containerClassName="min-h-[260px]">
              <div
                className="p-8 md:p-12 flex flex-col md:flex-row md:items-center gap-6 md:gap-10"
              ...
              >
                <div className="flex-1 max-w-xl">
                  ...
                  <p className="mt-3 text-sm md:text-base text-muted-foreground leading-relaxed">
                    ⌘K searches every tool, category, recent and favorite. Never lift your hands off
                    the keyboard — the whole toolkit is one shortcut away.
                  </p>
                </div>
          ...
          <StaggerItem>
            <WobbleCard containerClassName="min-h-[240px]">
              <div className="p-8 h-full flex flex-col" data-motion-icon-group>
                ...
                <p className="mt-2 text-sm text-muted-foreground leading-relaxed">
                  Explain code, generate SQL &amp; regex, write commits — powered by Gemini,
                  optional.
                </p>
              </div>
            </WobbleCard>
