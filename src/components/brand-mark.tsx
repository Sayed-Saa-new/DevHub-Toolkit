...
export function BrandMark({ className, size = 24 }: { className?: string; size?: number }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="dh-g" x1="0" y1="0" x2="32" y2="32" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="currentColor" stopOpacity="1" />
          <stop offset="1" stopColor="currentColor" stopOpacity="0.55" />
        </linearGradient>
      </defs>
      {/* rounded square container */}
      <rect x="1" y="1" width="30" height="30" rx="8" fill="url(#dh-g)" />
      ...
      />
      {/* accent dot */}
      <circle cx="25.5" cy="24" r="1.6" fill="var(--background)" />
    </svg>
  );
}
