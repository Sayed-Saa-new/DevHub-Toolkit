...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "DevHub Toolkit — 23 developer tools in one place" },
      { name: "twitter:description", content: "JSON, Base64, JWT, UUID, hashes, regex, QR codes, color, gradients and more. Fast, minimal, keyboard-first." },
