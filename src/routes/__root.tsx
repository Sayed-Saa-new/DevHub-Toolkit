...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DevHub Toolkit — 55 Free Online Developer Tools" },
      { name: "description", content: "Free online JSON formatter, Base64 decoder, JWT decoder, UUID & hash generator, regex tester, QR codes, AI SQL & regex generators — 55 developer tools, no signup." },
      ...
      { property: "og:title", content: "DevHub Toolkit — 55 Free Online Developer Tools" },
      ...
      { name: "twitter:title", content: "DevHub Toolkit — 55 Free Online Developer Tools" },
