...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "44 free online developer tools: JSON formatter, Base64, JWT, UUID, hashes, regex, QR, AI SQL & regex — no signup." },
      ...
      { property: "og:description", content: "JSON, Base64, JWT, UUID, hashes, regex, QR, AI SQL & regex, and 35+ more. Fast, minimal, keyboard-first." },
