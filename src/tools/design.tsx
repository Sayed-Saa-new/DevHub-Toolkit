...
export function GradientTool() {
  ...
  return (
    <div className="space-y-4">
      <div
        className="rounded-xl border border-border h-56"
  ...
  return (
    <div className="grid md:grid-cols-[1fr_320px] gap-6">
      <div className="rounded-xl border border-border bg-muted/20 min-h-[360px] grid place-items-center p-8">
        <div
          className="size-40 rounded-2xl bg-card border border-border"
          style={{ boxShadow: `${x}px ${y}px ${blur}px ${spread}px ${shadowColor}` }}
        />
      </div>
      <div className="space-y-4">
        {(
          ...
          ] as [string, number, (n: number) => void, number, number][]
