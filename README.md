...
> 44 free, fast, keyboard-first developer utilities in one clean interface. Inspired by Vercel, Linear, and Raycast.
...
- **44 tools** — JSON, Base64, JWT, UUID, hashes, regex, QR, color, gradient, shadow, markdown, playground, cheat sheets, and more
